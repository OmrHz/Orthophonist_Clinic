...
public class Enfant extends Patient {
    ...
    // le constructeur
    public Enfant(String Nom , String Prenom , String Adresse, String DateNaissance,String LieuNaissance, String ClasseEtude , String NumeroMere , String NumeroPere) {
